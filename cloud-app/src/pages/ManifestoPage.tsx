    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-yellow-500/30 overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-6">
        ...
        <AdSection 
          ...
          link="/hoodies" 
          image="https://i.pinimg.com/736x/ff/3b/79/ff3b79ca2b9a21294d4a0734238b0b24.jpg"
        />
        ...
        <AdSection 
          ...
          link="/baggy-jeans" 
          reverse
          image="https://i.pinimg.com/736x/f6/e6/08/f6e608694f000988a325f6bad12f9ee4.jpg"
        />
        ...
        <AdSection 
          ...
          link="/couples-outfit" 
          image="https://i.pinimg.com/736x/58/b2/d4/58b2d4afaae9ee6953344f5c3dccb318.jpg"
        />
